  ...
  methods: {
    ...
    addEventsForElement (el) {
      ...
      const eventHandlerList = [
        ...
        { name: _ ? 'wheel' : 'wheel', handler: this.handleEnd },
...
.smooth-picker {
  ...
  .smooth-handle-layer {
    ...
    .smooth-top {
      ...
      background: linear-gradient(180deg,#fff 10%,hsla(0,0%,100%,.3));
    ...
    .smooth-bottom {
      ...
      background: linear-gradient(0deg,#fff 10%,hsla(0,0%,100%,.3));
      transform: translate3d(0, 0, 5.625em);
    }
  }
}
