...
<style lang="scss" scoped>
  ...
  @function webkit-slider-thumb-shadow($i: 1) {
    $val: 0 -#{$i}px 0 -#{($_thumb-height - $_track-height) / 2} #{$_upper-color};
    @if $i == 1 {
  ...
  // Webkit
  .verticalRange[type="range"]::-webkit-slider-runnable-track {
    width: 100%;
    height: $_height;
    background: $_lower-background;
  }

  .verticalRange[type="range"]::-webkit-slider-thumb {
    position: relative;
    appearance: none;
  ...
  // Firefox
  .verticalRange[type="range"]::-moz-range-track,
  .verticalRange[type="range"]::-moz-range-progress {
    width: 100%;
    height: $_height;
  ...
  .verticalRange[type="range"]::-moz-range-thumb {
    appearance: none;
    margin: 0;
    height: $_thumb-height;
    width: $_thumb-height;
  ...
  // Internet Exploder
  .verticalRange[type="range"]::-ms-track {
    width: 100%;
    height: $_height;
    border: 0;
  ...
  .verticalRange[type="range"]::-ms-fill-lower {
    background: $_lower-background;
  }

  .verticalRange[type="range"]::-ms-fill-upper {
    background: $_upper-background;
  }

  .verticalRange[type="range"]::-ms-thumb {
    appearance: none;
    height: $_thumb-height;
    width: $_thumb-height;
    background: $_thumb-image;
