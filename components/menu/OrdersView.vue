...
<template>
  <ul class="cateringViewMenu">
    <li class="cateringViewMenu-item" @click="$emit('click-handler')">
      <nuxt-link :to="localePath({ path: `/` })" class="cateringViewMenu-href">
        ...
        <img
          class="cateringViewMenu-arrow"
          src="~/assets/icons/L_arrow.svg"
          alt=""
        >
      </nuxt-link>
    </li>
